...
const CoreServicesNew = () => {
  ...
  return (
    <div
      className="py-5 block lg:hidden lg:py-10 scroll-m-10"
      id="specialized-serv"
    >
      <Container>
        <div className="mb-6">
                  ...
                  <>
                    {CORE_SERVICES3[expanded].buttons.map((item, index) => (
                      <Link
                        ...
                        className="flex justify-center opacity-0 animate-opacity-anim rounded-tr-2xl rounded-bl-2xl bg-primary text-white relative gap-4 transition-all duration-300 shadow-[0_2px_11px_1px_#9E7F61] p-4 py-3  cursor-pointer hover:bg-transparent hover:text-olive-dark"
                        key={index}
