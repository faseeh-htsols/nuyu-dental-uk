...
const QualtiyCare = () => {
  return (
    <div className="py-5 lg:py-12 bg-[url(/white-textured.webp)]">
      <Container>
        ...
        <p className="text-base text-[#333] text-center py-6">
          ...
          offer{" "}
          <Link className="font-bold" href={"/our-pricing"}>
            flexible payment options
          </Link>{" "}
          to make achieving your dream smile both simple and affordable. Your
          care is our priority, and we’re here to ensure your journey is as
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-7">
          ...
          <div className="flex flex-col justify-center gap-4 ">
            ...
            <ul className="text-sm list-disc marker:text-primary ps-3 flex flex-col gap-4 text-[#333] [&>li]:marker:text-2xl">
              <li>
            ...
            <div className="pt-5 flex justify-center lg:block">
              <SimpleButton href="/our-pricing/fees" variant="primary">
