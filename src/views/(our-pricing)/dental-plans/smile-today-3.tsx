...
const SmileTodayPlan = ({ variant }: ISmileTodayThree) => {
  ...
  return (
    <>
      <div className="py-5 lg:py-10 btns-animate-container" ref={btnRef}>
        <Container>
          <div className="flex flex-col lg:flex-row gap-7  justify-center bg-[url(/bg-try.png)] rounded-tr-[50px] rounded-bl-[50px]">
            <div className="w-full lg:w-[60%]">
              <div className=" p-10">
                <HeadingTwo classes="text-white text-center lg:text-left">
                  {variant
                    ? "HOW CAN WE MAKE YOU SMILE TODAY"
                    : "ARE YOU READY TO START YOUR SMILE JOURNEY?"}
                </HeadingTwo>
                <div className="flex gap-5 items-center justify-between">
                  <p className="text-sm text-white py-5 w-full lg:w-[80%]">
                    Whether you’re exploring treatments or ready to start, we’re
                    here for you. Chat with the team for a tailored advice, book
                    a consultation, or reach out – whichever works best for you.
                  </p>
                </div>
                <div
