    ...
    <div className="py-28 bg-[url('/special-offer-composite.webp')] bg-cover text-white">
      <Container>
        <HeadingTwo classes="mb-6 text-white">
          Our Special Offer on <br /> Full Arch Implants
        </HeadingTwo>
        <div className="mb-6">
        ...
        {/* <p className="mb-6">Save thousands with Regent Dental</p> */}
        <div className="flex flex-row">
          <div className="lg:w-[60%] flex flex-row gap-5  flex-wrap">
            <div className="flex flex-row gap-3 bg-black/50 w-full md:w-[calc(50%-10px)] border border-white p-4">
              <Image
              ...
              <div>
                ...
                <p className="uppercase">your treatment</p>
              </div>
            </div>
            <div className="flex flex-row gap-3  bg-black/50 w-full md:w-[calc(50%-10px)] border border-white p-4">
              <Image
