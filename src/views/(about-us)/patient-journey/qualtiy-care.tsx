  ...
  return (
    <div className="py-5 lg:py-12">
      <Container>
        ...
        <p className="text-base text-[#333] text-center py-3 lg:py-6">
          At{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 ">
          ...
          <div className="flex flex-col justify-center gap-2 lg:gap-4  ">
            ...
            <ul className="text-sm list-disc marker:text-primary ps-3 flex flex-col gap-2 lg:gap-4 text-[#333] [&>li]:marker:text-2xl">
              <li>
            ...
            <div className="pt-5 flex lg:justify-start justify-center flex-wrap gap-3">
