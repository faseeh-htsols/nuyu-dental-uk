...
const ContactUsCopy = () => {
  ...
  return (
    <div id="contact" className="scroll-mt-24 bg-[#faf6f5]">
      <Container>
        {/* form map starts */}
        <div className="rounded-[30px] mb-10 shadow-[0_0_12px_1px_rgba(0,0,0,.2)] overflow-hidden">
          <div className="relative grid grid-cols-1 lg:grid-cols-2">
            <div>
              <Image
                src={"/contact-us.webp"}
                alt="odern dental clinic with a dental chair, monitors, and sleek cabinetry"
                width={700}
                height={700}
                quality={100}
            ...
            <div className="bg-primary p-5 flex lg:items-center" id="contactIn">
              <Formik
                initialValues={{
                  name: "",
                  phonenumber: "",
