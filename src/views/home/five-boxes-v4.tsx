        ...
        <div className="flex flex-wrap justify-center gap-4 transition-all duration-300">
          {FIVE_BOXES2.map((item, index) => (
            ...
            >
              ...
              <p
                className="relative font-quicksand font-medium text-white text-sm text-center leading-tight transition-all duration-200 group-hover:text-shadow-sm"
