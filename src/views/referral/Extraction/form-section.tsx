...
const FormSection = () => {
  ...
  const validationSchema = Yup.object({
    ...
    summary: Yup.string().required("Short Summary is required"),
    mobile: Yup.string()
        ...
        <div className="flex flex-col lg:flex-row gap-5 pt-5">
          <div className="w-[300px] shrink-0 h-fit border border-primary rounded-tr-3xl rounded-bl-3xl mt-[120px]">
            ...
            <Link
              ...
              className="border border-olive-dark bg-primary text-white inline-block w-full p-4">
              ...
              <Form
                ...
                <div className="flex flex-col lg:flex-row gap-10 mt-5">
                  <div className="w-full lg:w-1/2">
                    <HeadingTwo classes="!text-2xl">Patient Details</HeadingTwo>
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    <HeadingTwo classes="!text-2xl mt-3">
                  ...
                  <div className="relative w-full">
                    <label
                      htmlFor="file"
                      className="cursor-pointer bg-primary text-white py-2 px-4 rounded-lg shadow-md hover:bg-primary/90 transition duration-300 ease-in-out"
                    >
                      Choose File
                    </label>
                    <Field
                      ...
                      ref={fileInput}
                    />
                    <span id="file-name" className="ml-3 text-black/50">
                      No file chosen
                    </span>
                  </div>
                  <ErrorMessage
                ...
                <div className="flex items-center space-x-2 gap-12">
                  ...
                  <div className="mt-5">
                    ...
                    <span>
                      ...
                      <a href="/privacy-cookie-policy" className="text-primary">
                        privacy policy
                      </a>{" "}
                      before continuing.
                    </span>
                ...
                <div className="flex gap-4 mt-5">
                  <button
                    type="button"
                    className="border border-primary text-primary p-2 rounded-3xl w-[30%] duration-300 hover:rounded-tr-none hover:rounded-bl-none">
                    Clear
                  </button>
                  <button
                    type="submit"
