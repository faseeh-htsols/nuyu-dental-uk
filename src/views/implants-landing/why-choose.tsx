...
const WhyChoose = () => {
  return (
    <div className="bg-[url('/why-chose-dental-implants.webp')] bg-center bg-cover h-[90vh]">
        ...
        <div className="flex flex-row justify-end h-full items-center">
          <div className="md:w-[50%] lg:w-[40%] bg-white rounded-bl-2xl rounded-tr-2xl p-8 flex flex-col gap-4 justify-center ">
            ...
            <p className="text-center lg:text-left">
              This isn’t dentistry as usual - NUYU combines world-class implant
              care with a space that looks and feels extraordinary.
            </p>
